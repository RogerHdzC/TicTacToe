...
class ViewController: UIViewController {
    ...
    func checkOppositeCorner() -> Bool {
        var moved = false
        if board[0] == "X" && board[8] == "_" {
            setMove(number: 8, mark: "O")
            moved = true
        } else if board[8] == "X" && board[0] == "_" {
            setMove(number: 8, mark: "O")
            moved = true
        } else if board[2] == "X" && board[6] == "_" {
            setMove(number: 8, mark: "O")
            moved = true
        } else if board[6] == "X" && board[2] == "_" {
            setMove(number: 8, mark: "O")
            moved = true
        }
        return moved
    ...
    func checkGameOver() -> Bool {
        ...
        if board[0] == "X" && board[1] == "X" && board[2] == "X" ||
            ...
            isGameOver = true
            userTurn = false
            showAlert(message: "it's a DRAWN")
        }
        return isGameOver
